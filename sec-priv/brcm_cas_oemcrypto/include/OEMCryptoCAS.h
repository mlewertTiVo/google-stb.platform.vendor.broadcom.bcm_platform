 ...
 * OEMCryptoCAS.h
 *
 * Reference APIs needed to support Widevine's CAS-related crypto algorithms.
 *
 * See the document "Widevine Security Integration Guide for Conditional
 * Access Systems" for a description of this API.
 *
 *********************************************************************/

#ifndef OEMCRYPTO_CAS_H_
#define OEMCRYPTO_CAS_H_
...
/*
 * Flags indicating data endpoints in OEMCrypto_DecryptCAS.
 */
#define OEMCrypto_FirstSubsample 1
#define OEMCrypto_LastSubsample 2

/* OEMCrypto_EncryptPatternDesc
 *  This is used in OEMCrypto_DecryptCAS to indicate the encrypt/skip pattern.
 *  The same scheme as specified in the CENC standard is used.
 */
typedef struct {
 ...
 * Obfuscation Renames.
 */
#define OEMCrypto_Initialize               _ocas01
#define OEMCrypto_Terminate                _ocas02
#define OEMCrypto_InstallKeybox            _ocas03
#define OEMCrypto_GetKeyData               _ocas04
#define OEMCrypto_IsKeyboxValid            _ocas05
#define OEMCrypto_GetRandom                _ocas06
#define OEMCrypto_GetDeviceID              _ocas07
#define OEMCrypto_WrapKeybox               _ocas08
#define OEMCrypto_OpenSession              _ocas09
#define OEMCrypto_CloseSession             _ocas10
#define OEMCrypto_DecryptCTR_V10           _ocas11
#define OEMCrypto_GenerateDerivedKeys      _ocas12
#define OEMCrypto_GenerateSignature        _ocas13
#define OEMCrypto_GenerateNonce            _ocas14
#define OEMCrypto_LoadKeys_V8              _ocas15
#define OEMCrypto_RefreshKeys              _ocas16
#define OEMCrypto_SelectKey_V13            _ocas17
#define OEMCrypto_RewrapDeviceRSAKey       _ocas18
#define OEMCrypto_LoadDeviceRSAKey         _ocas19
#define OEMCrypto_GenerateRSASignature_V8  _ocas20
#define OEMCrypto_DeriveKeysFromSessionKey _ocas21
#define OEMCrypto_APIVersion               _ocas22
#define OEMCrypto_SecurityLevel            _ocas23
#define OEMCrypto_Generic_Encrypt          _ocas24
#define OEMCrypto_Generic_Decrypt          _ocas25
#define OEMCrypto_Generic_Sign             _ocas26
#define OEMCrypto_Generic_Verify           _ocas27
#define OEMCrypto_GetHDCPCapability_V9     _ocas28
#define OEMCrypto_SupportsUsageTable       _ocas29
#define OEMCrypto_UpdateUsageTable         _ocas30
#define OEMCrypto_DeactivateUsageEntry_V12 _ocas31
#define OEMCrypto_ReportUsage              _ocas32
#define OEMCrypto_DeleteUsageEntry         _ocas33
#define OEMCrypto_DeleteOldUsageTable      _ocas34
#define OEMCrypto_LoadKeys_V9_or_V10       _ocas35
#define OEMCrypto_GenerateRSASignature     _ocas36
#define OEMCrypto_GetMaxNumberOfSessions   _ocas37
#define OEMCrypto_GetNumberOfOpenSessions  _ocas38
#define OEMCrypto_IsAntiRollbackHwPresent  _ocas39
#define OEMCrypto_CopyBuffer               _ocas40
#define OEMCrypto_QueryKeyControl          _ocas41
#define OEMCrypto_LoadTestKeybox_V13       _ocas42
#define OEMCrypto_ForceDeleteUsageEntry    _ocas43
#define OEMCrypto_GetHDCPCapability        _ocas44
#define OEMCrypto_LoadTestRSAKey           _ocas45
#define OEMCrypto_Security_Patch_Level     _ocas46
#define OEMCrypto_LoadKeys_V11_or_V12      _ocas47
#define OEMCrypto_DecryptCAS               _ocas48
#define OEMCrypto_GetProvisioningMethod    _ocas49
#define OEMCrypto_GetOEMPublicCertificate  _ocas50
#define OEMCrypto_RewrapDeviceRSAKey30     _ocas51
#define OEMCrypto_SupportedCertificates       _ocas52
#define OEMCrypto_IsSRMUpdateSupported        _ocas53
#define OEMCrypto_GetCurrentSRMVersion        _ocas54
#define OEMCrypto_LoadSRM                     _ocas55
#define OEMCrypto_LoadKeys_V13                _ocas56
#define OEMCrypto_RemoveSRM                   _ocas57
#define OEMCrypto_CreateUsageTableHeader      _ocas61
#define OEMCrypto_LoadUsageTableHeader        _ocas62
#define OEMCrypto_CreateNewUsageEntry         _ocas63
#define OEMCrypto_LoadUsageEntry              _ocas64
#define OEMCrypto_UpdateUsageEntry            _ocas65
#define OEMCrypto_DeactivateUsageEntry        _ocas66
#define OEMCrypto_ShrinkUsageTableHeader      _ocas67
#define OEMCrypto_MoveEntry                   _ocas68
#define OEMCrypto_CopyOldUsageEntry           _ocas69
#define OEMCrypto_CreateOldUsageEntry         _ocas70
#define OEMCrypto_GetAnalogOutputFlags        _ocas71
#define OEMCrypto_LoadTestKeybox              _ocas78
#define OEMCrypto_LoadEntitledContentKeys     _ocas79
 ...
 *   memory associated with it will be freed.  It is the OEMCrypto client's
 ...
 *
 *   Refer to document "Widevine Security Integration Guide for Conditional
 *   Access Systems" for details. This function computes the AES-128-CMAC of the
 ...
 * Parameters:
 *   session (in) - handle for the session to be used.
 *   program_id (in) - the ts program for which the keys will be used.
 ...
 *   called.  The elapsed time clock is used in OEMCrypto_DecryptCAS().
 *
 ...
 *   subsequent decryption operations (OEMCrypto_DecryptCAS()) for this
 ...
 *           passed in via OEMCrypto_DecryptCAS(). If the key is 256 bits it
 ...
 *                       mode when used in later calls to OEMCrypto_DecryptCAS.
 *                       This should be ignored when the key is used for
 *                       Generic Crypto calls.
 *
 * Threading:
 *   This function may be called simultaneously with functions on other
 *   sessions, but not with other functions on this session.
 ...
 *   OEMCrypto_DecryptCAS begins storing data out_buffer->secure.offset bytes
 *   after the beginning of the secure buffer.
 *
 ...
 */
OEMCryptoResult OEMCrypto_DecryptCAS(
    OEMCrypto_SESSION session, const uint8_t* data_addr, size_t data_length,
    bool is_encrypted, const uint8_t* iv, size_t block_offset,
    OEMCrypto_DestBufferDesc* out_buffer,
    const OEMCrypto_EncryptPatternDesc* pattern, uint8_t subsample_flags);
 ...
 *   the same as in OEMCrypto_DecryptCAS, above.
 *
 *   The main difference between this and OEMCrypto_DecryptCAS is that this
 *   function does not need an open session, and it may be called concurrently
 *   with other session functions on a multithreaded system. In particular, an
 ...
 *  Provisioning 3.0 in the document "Widevine Security Integration Guide for
 ...
 *
 * Returns:
 *   The supported API, as specified in the header file OEMCryptoCAS.h.
 *
 * Version:
 ...
 *
 * Description:
 *   Returns the current number of open OEMCrypto sessions. The OEMCrypto client
 *   and OEMCrypto consumers can query this value so they can use resources more
 *   effectively.
 *
 * Parameters:
 ...
 *   the device. The OEMCrypto client and OEMCrypto consumers can query this
 *   value so they can use resources more effectively. If the maximum number of
 *   sessions depends on a dynamically allocated shared resource, the returned
 *   value should be a best estimate of the maximum number of sessions.
 *
 ...
 *   only be called if the caller finds no existing usage table on the file
 ...
 *   the header is still loaded.  This warning may be logged by the caller.
 *
 *
 * Parameters:
 ...
 *  increase the size of the usage table header.  The caller can delete some
 ...
 *   warning may be logged by the caller.  If the generation number is off
 ...
 *   cleared.  It is the responsibility of the caller to call this function
 *   and save the usage table before the next call to ReportUsage and before
 *   the CAS layer is terminated.  Failure to do so will result in generation
 ...
 *   CAS layer after it has  defragmented the usage table and can delete unused
 ...
 *   the CAS layer to defragment the usage table. This does not modify any data
 ...
 *   CAS layer’s responsibility to call UpdateUsageEntry after moving an entry.
