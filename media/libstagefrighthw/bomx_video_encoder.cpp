...
static const char *g_roles[] = {"video_encoder.avc", "video_encoder.vp8"};
static const unsigned int g_numRoles = sizeof(g_roles)/sizeof(const char *);
static int g_roleCodec[] = {OMX_VIDEO_CodingAVC, OMX_VIDEO_CodingVP8};
    ...
    OMX_INOUT OMX_PTR pComponentParameterStructure)
{
    ...
    case OMX_IndexParamVideoProfileLevelQuerySupported:
    {
        ...
        case OMX_VIDEO_CodingAVC:
            ...
            pProfileLevel->eLevel = ( m_maxFrameWidth > 1280 && m_maxFrameHeight > 720 ) ? (OMX_U32)OMX_VIDEO_AVCLevel4 : (OMX_U32)OMX_VIDEO_AVCLevel31;
            break;
        case OMX_VIDEO_CodingVP8:
...
NEXUS_Error BOMX_VideoEncoder::AllocateEncoderResource()
{
    ...
    if ( property_get_int32(BCM_RO_MEDIA_ITB_DESC_DEBUG, 0) )
    {
        ...
        strftime(fname, sizeof(fname), "/data/vendor/nxmedia/venc-%F_%H_%M_%S.csv", timeinfo);
    ...
    if ( property_get_int32(BCM_RO_MEDIA_INPUT_DEBUG, 0) )
    {
        ...
        time(&rawtime);
        timeinfo = localtime(&rawtime);
        strftime(fname, sizeof(fname), "/data/vendor/nxmedia/venc-%F_%H_%M_%S.input", timeinfo);
