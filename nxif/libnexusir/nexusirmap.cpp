...
static __u16 key(const char * name)
{
    ...
    static const struct keyname linux_keys[] = {
        ...
        DEFINE_KEY(NUMERIC_A),
        DEFINE_KEY(NUMERIC_B),
        DEFINE_KEY(NUMERIC_C),
        DEFINE_KEY(NUMERIC_D),
        ...
        DEFINE_KEY(KBDINPUTASSIST_PREV),
        DEFINE_KEY(KBDINPUTASSIST_NEXT),
        DEFINE_KEY(KBDINPUTASSIST_PREVGROUP),
        DEFINE_KEY(KBDINPUTASSIST_NEXTGROUP),
        DEFINE_KEY(KBDINPUTASSIST_ACCEPT),
        DEFINE_KEY(KBDINPUTASSIST_CANCEL),

        DEFINE_KEY(RIGHT_UP),
        DEFINE_KEY(RIGHT_DOWN),
        DEFINE_KEY(LEFT_UP),
        DEFINE_KEY(LEFT_DOWN),

        DEFINE_KEY(ROOT_MENU),
        DEFINE_KEY(MEDIA_TOP_MENU),
        DEFINE_KEY(NUMERIC_11),
        DEFINE_KEY(NUMERIC_12),
        DEFINE_KEY(AUDIO_DESC),
        DEFINE_KEY(3D_MODE),
        DEFINE_KEY(NEXT_FAVORITE),
        DEFINE_KEY(STOP_RECORD),
        DEFINE_KEY(PAUSE_RECORD),
        DEFINE_KEY(VOD),
        DEFINE_KEY(UNMUTE),
        DEFINE_KEY(FASTREVERSE),
        DEFINE_KEY(SLOWREVERSE),
        DEFINE_KEY(DATA),
