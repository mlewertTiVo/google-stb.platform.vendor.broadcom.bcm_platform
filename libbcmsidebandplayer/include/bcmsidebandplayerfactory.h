 ...
 *
 *****************************************************************************/
#ifndef BCM_SIDEBAND_PLAYER_FACTORY_H
#define BCM_SIDEBAND_PLAYER_FACTORY_H

class BcmSidebandPlayer {
public:
    virtual ~BcmSidebandPlayer() {};
    virtual int start(int x, int y, int w, int h) = 0;
    virtual void stop() = 0;
    virtual bool setWindowPosition(int x, int y, int w, int h) = 0;
};
