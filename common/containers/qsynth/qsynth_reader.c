...
Project  :  QSYNTH Library
Module   :  QSYNTH Reader

FILE DESCRIPTION
Implementation of a QSYNTH reader.  This reader reads midi files, first parsing
the file to extract duration, then passing the whole file to the codec.  It then
sends 'play' or 'seek' packets to maintain the interaction between typical
reader and codec.
=============================================================================*/
#include <stdlib.h>
#include <string.h>
