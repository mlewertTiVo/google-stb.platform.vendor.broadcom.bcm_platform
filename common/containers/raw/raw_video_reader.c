...
FILE DESCRIPTION
Implementation of a Raw Video reader.

Raw video files must contain the description of the video format in
the filename itself. This description must be in the form:
"_C%4.4sW%iH%iF%i#%iS%i" where C describes the fourcc of the codec,
W and H describe the with and height, F describes the frame rate
as a rational and S specifies the size of a frame.
Only C/W/H are mandatory.

Alternatively, this container also supports the YUV4MPEG2 format as
described in http://wiki.multimedia.cx/index.php?title=YUV4MPEG2
=============================================================================*/
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
