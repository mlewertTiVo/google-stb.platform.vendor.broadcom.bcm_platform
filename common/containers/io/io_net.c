...
Module   :  Net I/O
File     :  $RCSfile: io_net.c,v $
Revision :  $Revision: #0 $

FILE DESCRIPTION
Implementation of a net container I/O module. Supports TCP stream clients and
UDP packet senders/receivers.

Data sent and received can be captured in packet files by defining the
IO_NET_CAPTURE_PACKETS macro.
=============================================================================*/
