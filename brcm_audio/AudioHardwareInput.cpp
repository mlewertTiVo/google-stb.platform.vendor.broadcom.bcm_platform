...
** Modifications copyright (C) 2015 Broadcom Canada Ltd.
**
...
#if ATV_REMOTE_ONLY
    // Handle ATV remote only by ignoring all non-voice-recognition devices
    if (!devInfo.forVoiceRecognition) {
        ALOGW("AudioHardwareInput::onDeviceFound %d:%d dropped.",
