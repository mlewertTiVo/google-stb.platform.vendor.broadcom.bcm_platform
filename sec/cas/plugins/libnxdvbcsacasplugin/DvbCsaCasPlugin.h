...
#ifndef DVBCSA_CAS_PLUGIN_H_
#define DVBCSA_CAS_PLUGIN_H_
...
class DvbCsaCasSession;

class DvbCsaCasFactory : public CasFactory {
public:
    DvbCsaCasFactory() {}
    virtual ~DvbCsaCasFactory() {}
...
class DvbCsaDescramblerFactory : public DescramblerFactory {
public:
    DvbCsaDescramblerFactory() {}
    virtual ~DvbCsaDescramblerFactory() {}
...
class DvbCsaCasPlugin : public CasPlugin {
public:
    DvbCsaCasPlugin(void *appData, CasPluginCallback callback);
    virtual ~DvbCsaCasPlugin();
...
class DvbCsaDescramblerPlugin : public DescramblerPlugin {
public:
    DvbCsaDescramblerPlugin() {}
    virtual ~DvbCsaDescramblerPlugin() {};
...
private:
    std::shared_ptr<DvbCsaCasSession> mCASSession;
};

} // namespace dvbcsacascas
} // namespace android

#endif // DVBCSA_CAS_PLUGIN_H_
