...
ifeq ($(DTCP_IP_SAGE_SUPPORT),y)
LOCAL_SRC_FILES := refsw/nexus/lib/dtcp_ip_sage/examples/http_server.c
else
LOCAL_SRC_FILES := refsw/nexus/lib/dtcp_ip/apps/http_server.c
endif

LOCAL_MODULE := dtcpip_server
