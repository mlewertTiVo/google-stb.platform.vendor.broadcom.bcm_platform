...
ifeq ($(LOCAL_DEVICE_FULL_TREBLE),y)
PRODUCT_COPY_FILES += \
   $(TOP)/${BCM_VENDOR_STB_ROOT}/${RELEASE_PREBUILTS}/android.hardware.drm@1.0-service.widevine:$(TARGET_COPY_OUT_VENDOR)/bin/hw/android.hardware.drm@1.0-service.widevine:widevine \
   $(TOP)/${BCM_VENDOR_STB_ROOT}/${RELEASE_PREBUILTS}/android.hardware.drm@1.0-service.widevine.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/android.hardware.drm@1.0-service.widevine.rc:widevine
endif
