...
define generate-cmdline-info-module
	...
	awk -f $(NEXUS_TOP)/../BSEAV/tools/bmemperf/include/bmemperf_info_post.awk $(NEXUS_TOP)/../../bcm_platform/tools/bmemperf/cmdline/bmemperf_info.auto.c > $(NEXUS_TOP)/../../bcm_platform/tools/bmemperf/cmdline/bmemperf_info.auto.tmp
	cat $(NEXUS_TOP)/../../bcm_platform/tools/bmemperf/cmdline/bmemperf_info.auto.tmp >> $(NEXUS_TOP)/../../bcm_platform/tools/bmemperf/cmdline/bmemperf_info.auto.c
	rm $(NEXUS_TOP)/../../bcm_platform/tools/bmemperf/cmdline/bmemperf_info.auto.tmp
endef
