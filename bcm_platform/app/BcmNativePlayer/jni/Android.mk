...
LOCAL_SHARED_LIBRARIES := liblog libcutils libutils libbinder libb_os libb_playback_ip libb_psip $(NEXUS_LIB)
...
LOCAL_C_INCLUDES += vendor/broadcom/refsw/nexus/utils
LOCAL_C_INCLUDES += $(JNI_H_INCLUDE)

LOCAL_SRC_FILES := media_player.c dvr_crypto.c namevalue.c jni_BcmNativePlayer.cpp
...
LOCAL_MODULE := libjni_BcmNativePlayer
