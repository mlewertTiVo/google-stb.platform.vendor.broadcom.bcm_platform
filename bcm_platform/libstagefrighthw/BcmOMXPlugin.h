...
#ifndef BCM_OMX_PLUGIN_H_

#define BCM_OMX_PLUGIN_H_

#include <OMXPluginBase.h>

namespace android {

struct BcmOMXPlugin : public OMXPluginBase {
    BcmOMXPlugin();
	virtual ~BcmOMXPlugin();
...
private:
    ...
    BcmOMXPlugin(const BcmOMXPlugin &);
    BcmOMXPlugin &operator=(const BcmOMXPlugin &);
};
