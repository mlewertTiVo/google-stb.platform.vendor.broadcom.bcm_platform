...
# 
# libOMX.BCM.vp9.DECODER
#
include $(CLEAR_VARS)
LOCAL_C_INCLUDES+=$(COMMON_INCLUDE_FILES)
LOCAL_SHARED_LIBRARIES:=$(COMMON_SHARED_LIBRARIES)
LOCAL_CFLAGS := $(COMMON_C_FLAGS)
LOCAL_CFLAGS += -DOMX_COMPRESSION_FORMAT=OMX_VIDEO_CodingVP9
LOCAL_MODULE_TAGS:= optional
LOCAL_SRC_FILES:= $(COMMON_SOURCE_FILE)
LOCAL_MODULE:=libOMX.BCM.vp9.decoder
include $(BUILD_SHARED_LIBRARY)
...
LOCAL_SHARED_LIBRARIES:=$(COMMON_SHARED_LIBRARIES)
LOCAL_CFLAGS := $(COMMON_C_FLAGS)
LOCAL_CFLAGS += -DOMX_COMPRESSION_FORMAT=OMX_VIDEO_CodingH265
LOCAL_MODULE_TAGS:= optional
LOCAL_SRC_FILES:= $(COMMON_SOURCE_FILE)
