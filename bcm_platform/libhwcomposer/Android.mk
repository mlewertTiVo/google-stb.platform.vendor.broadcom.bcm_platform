...
LOCAL_SHARED_LIBRARIES := liblog libEGL libcutils libdl libbinder libutils libnexusipcclient libnexus

# Make sure gralloc is built first
LOCAL_ADDITIONAL_DEPENDENCIES := $(TARGET_OUT_SHARED_LIBRARIES)/hw/gralloc.bcm_platform.so
LOCAL_LDFLAGS := -lnexus -L$(REFSW_PATH)/bin -l:gralloc.bcm_platform.so -Lout/target/product/bcm_platform/system/lib/hw
...
LOCAL_CFLAGS += $(NEXUS_CFLAGS) -DANDROID -DLOG_TAG=\"hwcomposer\" $(MP_CFLAGS)
