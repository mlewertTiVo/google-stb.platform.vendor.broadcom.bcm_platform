...
ifeq ($(ANDROID_ENABLE_1080P_GRAPHICS_FB_DISPLAY),y)
MP_CFLAGS += -DANDROID_ENABLE_1080P_GRAPHICS_FB_DISPLAY=1
else
MP_CFLAGS += -DANDROID_ENABLE_1080P_GRAPHICS_FB_DISPLAY=0
endif
